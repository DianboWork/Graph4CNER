...
net_arg.add_argument('--gat_nhidden', type=int)
net_arg.add_argument('--gat_nhead', type=int)
net_arg.add_argument('--gat_layer', type=int, choices=[1, 2])
net_arg.add_argument('--strategy', type=str, choices=['v', 'n', 'm'])
net_arg.add_argument("--alpha", type=float, default=0.1)
net_arg.add_argument('--dropout', type=float)
net_arg.add_argument('--droplstm', type=float)
net_arg.add_argument('--dropgat', type=float)
net_arg.add_argument('--gaz_dropout', type=float)
...
data_arg.add_argument('--gaz_file', type=str, help="lexical embeddings file")
data_arg.add_argument('--char_embedding_path', type=str, help="characher embeddings file")
...
learn_arg.add_argument('--batch_size', type=int)
learn_arg.add_argument('--max_epoch', type=int, default=150)
learn_arg.add_argument('--lr', type=float)
