...
net_arg.add_argument('--strategy', type=str, choices=['v', 'n', 'm'])
...
data_arg.add_argument('--dataset_name', type=str, default='msra')
data_arg.add_argument('--train_file', type=str, default="./data/dataset/msr/msr_training.txt", help="train file")
data_arg.add_argument('--test_file', type=str, default="./data/dataset/msr/msr_test_gold.txt", help="test file")
data_arg.add_argument('--dev_file', type=str, default="./data/dataset/msr/msr_test_gold.txt", help="dev file")
data_arg.add_argument('--gaz_file', type=str, default="./data/embeddings/sgns.merge.word", help="lexical embeddings file") # Tencent_AILab_ChineseEmbedding.txt
