...
net_arg.add_argument('--strategy', type=str, default="v", choices=['v', 'n', 'm'])
net_arg.add_argument("--alpha", type=float, default=0.1)
net_arg.add_argument('--dropout', type=float, default=0.7)
net_arg.add_argument('--droplstm', type=float, default=0.7)
net_arg.add_argument('--dropgat', type=float, default=0)
net_arg.add_argument('--gaz_dropout', type=float, default=0.4)

# Data
data_arg = add_argument_group('Data')
data_arg.add_argument('--dataset_name', type=str, default='OntoNote')
data_arg.add_argument('--train_file', type=str, default="./data/dataset/OntoNotes/OntoNotes_split_BIO.train", help="train file")
data_arg.add_argument('--test_file', type=str, default=".//data/dataset/OntoNotes/test.char.bio", help="test file")
data_arg.add_argument('--dev_file', type=str, default="./data/dataset/OntoNotes/OntoNotes_split_BIO.dev", help="dev file")
...
learn_arg.add_argument('--lr', type=float, default=0.01)
